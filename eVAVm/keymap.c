...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, LCTL(LSFT(KC_C)),LCTL(LSFT(KC_V)),TO(1),                                          KC_INSERT,      KC_PAGE_UP,     KC_HOME,        KC_END,         KC_PGDN,        KC_F12,         
    ...
    KC_APPLICATION, KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_C),     LCTL(KC_V),     TO(0),                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_voyager(
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {43,15,255}, {129,224,254}, {129,224,254}, {129,224,254}, {129,224,254}, {129,224,254}, {0,245,245}, {43,15,255}, {43,15,255}, {234,255,255}, {234,255,255}, {71,218,204}, {0,245,245}, {43,15,255}, {43,15,255}, {13,215,98}, {13,215,98}, {0,245,245}, {41,255,255}, {13,215,98}, {13,215,98}, {219,255,255}, {219,255,255}, {0,0,239}, {43,15,255}, {43,15,255}, {129,224,254}, {129,224,254}, {129,224,254}, {129,224,254}, {129,224,254}, {129,224,254}, {255,218,204}, {24,218,204}, {40,218,204}, {40,218,204}, {24,218,204}, {129,224,254}, {255,218,204}, {139,222,223}, {139,222,223}, {139,222,223}, {139,222,223}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255}, {43,15,255} },
